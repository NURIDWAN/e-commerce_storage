...
<div class="container">
    <article class="card" style="margin-top: 10vh; margin-bottom: 10vh">
        ...
        <div class="card-body">
            ...
            <div class="track">
                @if ($track->shipping_status == "pending")
                    ...
                    <div class="step active">
                        <span class="icon"> <i class="fa fa-check"></i></span>
                        <span class="text">Pesanan Di Dikonfirmasi</span>
                    </div>
                    ...
                    <div class="step">
                        <span class="icon"> <i class="fa fa-check"></i></span>
                        <span class="text">Pesanan Dalam Pwrjalanan</span>
                    </div>
                    ...
                    <div class="step active">
                        <span class="icon"> <i class="fa fa-check"></i></span>
                        <span class="text">Pesanan Ditunda</span>
                    </div>
